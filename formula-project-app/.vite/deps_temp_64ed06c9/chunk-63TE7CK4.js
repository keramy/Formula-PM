...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      __name(useSyncExternalStore$12, "useSyncExternalStore$1");
...
var _Subscribable = class _Subscribable {
  constructor() {
...
var Subscribable = _Subscribable;
...
__name(parseMutationArgs, "parseMutationArgs");
...
__name(parseMutationFilterArgs, "parseMutationFilterArgs");
...
var _FocusManager = class _FocusManager extends Subscribable {
  constructor() {
    super();
    this.setup = (onFocus) => {
...
__name(_FocusManager, "FocusManager");
...
var _OnlineManager = class _OnlineManager extends Subscribable {
  constructor() {
    super();
    this.setup = (onOnline) => {
      if (!isServer && window.addEventListener) {
...
__name(_OnlineManager, "OnlineManager");
var OnlineManager = _OnlineManager;
...
var _CancelledError = class _CancelledError {
  constructor(options) {
    this.revert = options == null ? void 0 : options.revert;
    this.silent = options == null ? void 0 : options.silent;
  }
};
__name(_CancelledError, "CancelledError");
var CancelledError = _CancelledError;
...
function createRetryer(config) {
  ...
  const shouldPause = /* @__PURE__ */ __name(() => !focusManager.isFocused() || config.networkMode !== "always" && !onlineManager.isOnline(), "shouldPause");
...
var _Removable = class _Removable {
  destroy() {
    this.clearGcTimeout();
  }
  scheduleGc() {
...
var _QueryCache = class _QueryCache extends Subscribable {
  constructor(config) {
    super();
    this.config = config || {};
    this.queries = [];
...
var _Mutation = class _Mutation extends Removable {
  constructor(config) {
    super();
    this.defaultOptions = config.defaultOptions;
...
var _MutationCache = class _MutationCache extends Subscribable {
  constructor(config) {
    super();
    this.config = config || {};
    this.mutations = [];
...
__name(_MutationCache, "MutationCache");
var MutationCache = _MutationCache;

// node_modules/@tanstack/query-core/build/lib/infiniteQueryBehavior.mjs
function infiniteQueryBehavior() {
  return {
    onFetch: /* @__PURE__ */ __name((context) => {
      context.fetchFn = () => {
...
var _QueryClient = class _QueryClient {
  constructor(config = {}) {
...
__name(_QueryClient, "QueryClient");
var QueryClient = _QueryClient;

// node_modules/@tanstack/query-core/build/lib/queryObserver.mjs
var _QueryObserver = class _QueryObserver extends Subscribable {
...
__name(_QueryObserver, "QueryObserver");
var QueryObserver = _QueryObserver;
...
var _QueriesObserver = class _QueriesObserver extends Subscribable {
...
__name(_QueriesObserver, "QueriesObserver");
var QueriesObserver = _QueriesObserver;

// node_modules/@tanstack/query-core/build/lib/infiniteQueryObserver.mjs
var _InfiniteQueryObserver = class _InfiniteQueryObserver extends QueryObserver {
  // Type override
  // Type override
  // Type override
...
__name(_InfiniteQueryObserver, "InfiniteQueryObserver");
var InfiniteQueryObserver = _InfiniteQueryObserver;

// node_modules/@tanstack/query-core/build/lib/mutationObserver.mjs
var _MutationObserver = class _MutationObserver extends Subscribable {
  constructor(client, options) {
    super();
    this.client = client;
    this.setOptions(options);
...
__name(_MutationObserver, "MutationObserver");
var MutationObserver = _MutationObserver;
...
var useQueryClient = /* @__PURE__ */ __name(({
  context
} = {}) => {
...
use-sync-external-store/cjs/use-sync-external-store-shim.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-63TE7CK4.js.map
