...
__name(getMatchRanking, "getMatchRanking");
...
function getClosenessRanking(testString, stringToRank) {
  ...
  __name(findMatchingCharacter, "findMatchingCharacter");
...
__name(getClosenessRanking, "getClosenessRanking");
...
__name(prepareValueForComparison, "prepareValueForComparison");
...
__name(getItemValues, "getItemValues");
...
__name(getAllValuesToRank, "getAllValuesToRank");
...
__name(getAccessorAttributes, "getAccessorAttributes");

// node_modules/@tanstack/react-query-devtools/build/lib/useLocalStorage.mjs
var React = __toESM(require_react(), 1);
var getItem = /* @__PURE__ */ __name((key) => {
  try {
...
__name(getQueryStatusColor, "getQueryStatusColor");
function getQueryStatusLabel(query) {
  return query.state.fetchStatus === "fetching" ? "fetching" : !query.getObserversCount() ? "inactive" : query.state.fetchStatus === "paused" ? "paused" : query.isStale() ? "stale" : "fresh";
}
__name(getQueryStatusLabel, "getQueryStatusLabel");
...
var displayValue = /* @__PURE__ */ __name((value, beautify = false) => {
  const {
    json
  } = esm_default.serialize(value);
  return JSON.stringify(json, null, beautify ? 2 : void 0);
}, "displayValue");
var getStatusRank = /* @__PURE__ */ __name((q) => q.state.fetchStatus !== "idle" ? 0 : !q.getObserversCount() ? 3 : q.isStale() ? 2 : 1, "getStatusRank");
var queryHashSort = /* @__PURE__ */ __name((a, b) => a.queryHash.localeCompare(b.queryHash), "queryHashSort");
var dateSort = /* @__PURE__ */ __name((a, b) => a.state.dataUpdatedAt < b.state.dataUpdatedAt ? 1 : -1, "dateSort");
var statusAndDateSort = /* @__PURE__ */ __name((a, b) => {
...
__name(isVerticalSide, "isVerticalSide");
function getOppositeSide(side) {
  return sides[side];
}
__name(getOppositeSide, "getOppositeSide");
function getSidedProp(prop, side) {
  return "" + prop + (side.charAt(0).toUpperCase() + side.slice(1));
}
__name(getSidedProp, "getSidedProp");
...
__name(getSidePanelStyle, "getSidePanelStyle");
...
__name(getResizeHandleStyle, "getResizeHandleStyle");
...
var ActiveQueryPanel = styled("div", () => ({
  ...
  "(max-width: 700px)": /* @__PURE__ */ __name((_props, theme) => ({
...
__name(ScreenReader, "ScreenReader");
...
var CopyButton = /* @__PURE__ */ __name(({
  value
}) => {
...
var Copier = /* @__PURE__ */ __name(() => React6.createElement("span", {
...
var ErrorCopier = /* @__PURE__ */ __name(() => React6.createElement("span", {
...
}, "See console")), "ErrorCopier");
var CopiedCopier = /* @__PURE__ */ __name(() => React6.createElement("span", {
...
var DefaultRenderer = /* @__PURE__ */ __name(({
  ...
  return React6.createElement(Entry, {
    ...
    onClick: /* @__PURE__ */ __name(() => toggleExpanded(), "onClick")
    ...
    onClick: /* @__PURE__ */ __name(() => setExpandedPages((old) => old.includes(index) ? old.filter((d) => d !== index) : [...old, index]), "onClick")
  }, React6.createElement(Expander, {
    expanded
...
function Explorer({
  ...
  let subEntries = [];
  const makeProperty = /* @__PURE__ */ __name((sub) => {
  ...
  return renderer({
    handleEntry: /* @__PURE__ */ __name((entry) => React6.createElement(Explorer, _extends({
      key: entry.label,
      value,
      renderer,
      copyable
    }, rest, entry)), "handleEntry"),
    type,
    subEntries,
    subEntryPages,
    value,
...
function ReactQueryDevtools({
  ...
  const handleDragStart = /* @__PURE__ */ __name((panelElement, startEvent) => {
    ...
    let newSize = 0;
    const run = /* @__PURE__ */ __name((moveEvent) => {
  ...
  React8.useEffect(() => {
    ...
    if (ref) {
      const handlePanelTransitionStart = /* @__PURE__ */ __name(() => {
        if (isResolvedOpen) {
          ref.style.visibility = "visible";
        }
      }, "handlePanelTransitionStart");
      const handlePanelTransitionEnd = /* @__PURE__ */ __name(() => {
        if (!isResolvedOpen) {
  ...
  return React8.createElement(Container, {
    ...
    isOpen: isResolvedOpen,
    setIsOpen,
    onDragStart: /* @__PURE__ */ __name((e) => handleDragStart(panelRef.current, e), "onDragStart"),
    errorTypes
...
__name(ReactQueryDevtools, "ReactQueryDevtools");
var useSubscribeToQueryCache = /* @__PURE__ */ __name((queryCache, getSnapshot, skip = false) => {
...
var ReactQueryDevtoolsPanel = React8.forwardRef(/* @__PURE__ */ __name(function ReactQueryDevtoolsPanel2(props, ref) {
  const {
    isOpen = true,
    styleNonce,
    setIsOpen,
  ...
  return React8.createElement(ThemeProvider, {
    ...
    onChange: /* @__PURE__ */ __name((e) => onPositionChange(e.target.value), "onChange")
    ...
    value: sort,
    onChange: /* @__PURE__ */ __name((e) => setSort(e.target.value), "onChange"),
    style: {
      flex: "1",
      minWidth: 75,
      marginRight: ".5em"
    ...
    type: "button",
    onClick: /* @__PURE__ */ __name(() => setBaseSort((old) => old * -1), "onClick"),
    style: {
      padding: ".3em .4em",
      marginRight: ".5em"
    }
    ...
    type: "button",
    onClick: /* @__PURE__ */ __name(() => queryCache.clear(), "onClick"),
    style: {
      padding: ".3em .4em",
      marginRight: ".5em"
    }
...
var ActiveQuery = /* @__PURE__ */ __name(({
  queryCache,
  activeQueryHash,
  queryClient,
  errorTypes
  ...
  const handleRefetch = /* @__PURE__ */ __name(() => {
  ...
  const triggerError = /* @__PURE__ */ __name((errorType) => {
  ...
  const restoreQueryAfterLoadingOrError = /* @__PURE__ */ __name(() => {
  ...
  return React8.createElement(ActiveQueryPanel, null, React8.createElement("div", {
    ...
    type: "button",
    onClick: /* @__PURE__ */ __name(() => queryClient.invalidateQueries(activeQuery), "onClick"),
    style: {
    ...
    type: "button",
    onClick: /* @__PURE__ */ __name(() => queryClient.resetQueries(activeQuery), "onClick"),
    style: {
      background: defaultTheme.gray
    }
  }, "Reset"), " ", React8.createElement(Button, {
    type: "button",
    onClick: /* @__PURE__ */ __name(() => queryClient.removeQueries(activeQuery), "onClick"),
    style: {
...
var QueryStatusCount = /* @__PURE__ */ __name(({
  queryCache
}) => {
...
var QueryRow = React8.memo(({
  ...
  return React8.createElement("div", {
    ...
    onClick: /* @__PURE__ */ __name(() => setActiveQueryHash(activeQueryHash === queryHash ? "" : queryHash), "onClick"),
    style: {
      display: "flex",
