...
var _ErrorResponseImpl = class _ErrorResponseImpl {
...
var ErrorResponseImpl = _ErrorResponseImpl;
...
function createRouter(init) {
  ...
  if (!initialMatches) {
    ...
    let isRouteInitialized = /* @__PURE__ */ __name((m) => {
      if (!m.route.loader) {
        return true;
      }
  ...
  __name(handleDiscoverRouteError, "handleDiscoverRouteError");
...
__name(loadLazyRouteChildren, "loadLazyRouteChildren");
...
var _RenderErrorBoundary = class _RenderErrorBoundary extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
var RenderErrorBoundary = _RenderErrorBoundary;
...
var _AwaitErrorBoundary = class _AwaitErrorBoundary extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      error: null
...
var AwaitErrorBoundary = _AwaitErrorBoundary;
...
var Link = React2.forwardRef(/* @__PURE__ */ __name(function LinkWithRef(_ref7, ref) {
  let {
    onClick,
    relative,
    reloadDocument,
...
var NavLink = React2.forwardRef(/* @__PURE__ */ __name(function NavLinkWithRef(_ref8, ref) {
  let {
