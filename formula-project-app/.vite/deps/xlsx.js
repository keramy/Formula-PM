...
function set_cptable(cptable) {
  $cptable = cptable;
  set_cp = /* @__PURE__ */ __name(function(cp) {
    current_codepage = cp;
    set_ansi(cp);
  }, "set_cp");
  debom = /* @__PURE__ */ __name(function(data) {
    if (data.charCodeAt(0) === 255 && data.charCodeAt(1) === 254) {
      return $cptable.utils.decode(1200, char_codes(data.slice(2)));
    }
    return data;
  }, "debom");
  _getchar = /* @__PURE__ */ __name(function _gc2(x) {
    if (current_codepage === 1200) return String.fromCharCode(x);
    return $cptable.utils.decode(current_codepage, [x & 255, x >> 8])[0];
  }, "_gc2");
  _getansi = /* @__PURE__ */ __name(function _ga2(x) {
    return $cptable.utils.decode(current_ansi, [x])[0];
  }, "_ga2");
  cpdoit();
}
__name(set_cptable, "set_cptable");
var DENSE = null;
var DIF_XL = true;
...
var SSF = {
  ...
  is_date: fmt_is_date,
  get_table: /* @__PURE__ */ __name(function get_table() {
...
var CFB = (/* @__PURE__ */ __name(function _CFB() {
  var exports = {};
  ...
  var _deflateRaw = (/* @__PURE__ */ __name(function _deflateRawIIFE() {
...
var rs_to_html = (/* @__PURE__ */ __name(function parse_rs_factory() {
  var nlregex = /(\r\n|\n)/g;
...
var parse_sty_xml = (/* @__PURE__ */ __name(function make_pstyx() {
...
__name(writeFileSyncXLSX, "writeFileSyncXLSX");
